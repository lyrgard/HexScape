...
import fr.lyrgard.hexScape.gui.desktop.layout.EvenlyDistributedLayout;
import fr.lyrgard.hexScape.gui.desktop.layout.FlowLayout;
...
public class Convert {
	...
	private static final EvenlyDistributedLayout EVENLY_DISTRIBUTED_LAYOUT = new EvenlyDistributedLayout();
	private static final FlowLayout FLOW_LAYOUT = new FlowLayout();
	...
	public LayoutManager layoutManager(final String type) {
		...
		} else if (typeCompare.equals("evenly-distributed")) {
			return EVENLY_DISTRIBUTED_LAYOUT;
		} else if (typeCompare.equals("flow")) {
			return FLOW_LAYOUT;
		}
